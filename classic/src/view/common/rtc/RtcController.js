Ext.define('NgcpCsc.view.common.rtc.RtcController', {
            ...
            rtcClient.onConnect(function() {
                ...
                rtcNetwork.onConnect(function() {
                    ...
                    call.onRemoteMedia(function(stream){
                        ...
                        // .onRemoteMediaEnded(function(){ $ct.incomingRemoteMediaEnded(); }) // XXX Should these both be invoking the same function?
                        .onEnded(function(reason){ $ct.incomingRemoteMediaEnded(reason) });
    ...
    incomingRemoteMediaEnded: function(reason) {
    ...
    callEnded: function() { // TODO Remove?
        var $ct = this;
        var $vm = $ct.getViewModel();
    },
    ...
    showIncomingCallPendingState: function (num, type) {
        var $vm = this.getViewModel();
