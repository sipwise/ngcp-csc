Ext.define('NgcpCsc.view.pages.account.AccountModel', {
    ...
    formulas: {
        ...
        checkReminder: function() {
            return Ext.String.format('<span class="fa fa-exclamation fa-3x"></span><span>{0}</span>', Ngcp.csc.locales.conversations.direction.forwarded[localStorage.getItem('languageSelected')]);
        }
    }
});
