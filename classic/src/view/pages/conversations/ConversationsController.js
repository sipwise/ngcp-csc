    ...
    renderPhoneIcon: function(value, meta, record) {
        ...
        switch (record.get('conversation_type')) {
            ...
            case 'sms':
                ...
                icon = Ngcp.csc.icons.sms_transparent + ' green-icon pointer';
                break;
            case 'chat':
                ...
                icon = Ngcp.csc.icons.chat + ' green-icon pointer';
                break;
            case 'fax':
    ...
    renderCallTypeIcons: function(value, meta, record) {
        ...
        switch (record.get('direction')) {
            ...
            case 'forwarded':
                ...
                return '<div><span class="' + color + ' ' + Ngcp.csc.icons.arrowright + '"></span><span class="' + color + ' ' + Ngcp.csc.icons.arrowright + '"></span></div>';
                break;
        };
        return Ext.String.format('<div class="{0}"></div>', icon);
    },
    ...
    renderShortCut: function(value, meta, record) {
        ...
        switch (record.get('conversation_type')) {
            ...
            case 'sms':
                ...
                icon = Ngcp.csc.icons.sms + ' green-icon pointer';
                break;
            case 'chat':
