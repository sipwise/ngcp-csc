Ext.define('NgcpCsc.view.pages.conversations.ConversationsController', {
    ...
    composeSms: function() {
        this.fireEvent('initrtc', 'smsComposer', null, false, true);
    },

    composeCall: function() {
        this.fireEvent('initrtc', 'phoneComposer', null, false, true);
    },

    composeFax: function() {
        this.fireEvent('initrtc', 'faxComposer', null, false, true);
    },
