                ...
                switch (record.get('conversation_type')) {
                    ...
                    case 'fax':
                        content = '<div class="card-wrapper hidden" id=' + record.get('id') + '>' +
                            ...
                            '<div class="card-icon-row">' +
                            '<div id="downloadFax-' + record.get('id') + '" class="card-icon" data-tooltip="' + Ngcp.csc.locales.conversations.tooltips.download_fax[localStorage.getItem('languageSelected')] + '"><a href="'+Ext.manifest.resources.path+'/docs/fax.pdf" target="_blank"><i class= "'+Ngcp.csc.icons.download2x+' green-icon pointer" aria-hidden="true"></i></a></div>' +
