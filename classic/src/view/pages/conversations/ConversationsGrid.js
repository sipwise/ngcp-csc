                ...
                switch (record.get('call_type')) {
                    ...
                    case 'fax':
                        content = '<div class="card-wrapper hidden" id=' + record.get('id') + '>' +
                            ...
                            '<div class="card-data-row"><span></span><b>' + Ngcp.csc.locales.common.date[localStorage.getItem('languageSelected')] + '</b>: ' + Ext.util.Format.date(record.get('start_time'), "d.m.Y h:i:s") + ' </div>' +
                            '<div class="card-icon-row">' +
                            '<div id="downloadFax-'+record.get('id')+'" data-callback="downloadFax" class="card-icon" data-tooltip="'+Ngcp.csc.locales.conversations.tooltips.download_fax[localStorage.getItem('languageSelected')]+'"><a href="resources/docs/fax.pdf" target="_blank"><i class="fa fa-file-pdf-o green-icon fa-2x pointer" aria-hidden="true"></i></a></div>' +
