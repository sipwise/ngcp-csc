                ...
                switch (record.get('call_type')) {
                    case 'call':
                        content = '<div class="card-wrapper hidden pointer" id=' + record.get('id') + '>' +
                            ...
                            '<div class="card-data-row"><span></span><b>' + Ngcp.csc.locales.conversations.charges[localStorage.getItem('languageSelected')] + '</b>: ' + record.get('charges') + record.get('currency') + ' </div>' +
