Ext.define('NgcpCsc.view.pages.callforward.CallForwardMainForm', {
    ...
    initComponent: function() {
        if (this._sourcesetStoreId) {
            ...
            Ext.getStore('firstSLStore') || Ext.create('NgcpCsc.store.CallForwardSourceset', {
        ...
        this.items = [{
            ...
            bind: {
                title: '{' + this._firstprefix + this._secondprefix + 'title}'
            },
            collapsible: true,
            collapsed: true,
            items: [{
                    ...
                    items: [{
                        ...
                        // bind: {
                        //     value: '{' + this._firstprefix + this._secondprefix + 'titleField-value}'
                        // }
                    }, {
                        xtype: 'button',
                        html: Ngcp.csc.locales.common.cancel_caps[localStorage.getItem('languageSelected')],
                        id: this._firstprefix + this._secondprefix + 'titleField-cancelButton',
                        margin: '0 0 0 10',
                        handler: 'cancelNewTitle'
                    }, {
                        xtype: 'button',
                        html: Ngcp.csc.locales.common.save_caps[localStorage.getItem('languageSelected')],
                        id: this._firstprefix + this._secondprefix + 'titleField-saveButton',
