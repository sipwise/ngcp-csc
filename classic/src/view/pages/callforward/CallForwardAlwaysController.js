Ext.define('NgcpCsc.view.pages.callforward.CallForwardAlwaysController', {
    ...
    clickSmCard: function(view, record, item, rowIndex, e, eOpts) {
        ...
        if (enableEdit) {
            ...
            Ext.ComponentQuery.query('#cf-new-source')[0].setValue(rec.get('from'));
            Ext.ComponentQuery.query('#cf-new-time')[0].setValue(rec.get('when'));
            Ext.ComponentQuery.query('#cf-new-destination')[0].setValue(rec.get('to'));
        };
    },
