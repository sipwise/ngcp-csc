Ext.define('NgcpCsc.view.pages.callforward.CallForwardController', {
    ...
    addCftOwnPhone: function (destinations) {
        ...
        // TODO: Here we only care about adding "own phone" object to th
    ...
    toggleAfterVoicemail: function (store) {
        // TODO a. Find any records with destination_cleaned === 'Voicemail',
        // and store index of that record. If more than one, store the first
        // TODO b. Create an array with any record indexes coming after
        // stored voicemail, e.g [4,5]
        // TODO c. Looping over the index array, and set after_voicemail to true
        // for those records
        return store;
    },
    ...
    populateDestinationStores: function (models) {
        ...
        if (store) {
            this.toggleAfterVoicemail(store);
            store.commitChanges();
        }
    },
