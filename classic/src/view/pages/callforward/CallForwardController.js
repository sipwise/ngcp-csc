Ext.define('NgcpCsc.view.pages.callforward.CallForwardController', {
    ...
    onEditClicked: function (el) {
        ...
        switch (true) {
            case (classList.contains('afterhours-edit-everybody')):
                console.log('everybody edit');
                // TODO: 1. Open the tab
                // TODO: 2. Show the grid
                break;
            case (classList.contains('afterhours-edit-lista')):
                console.log('list a edit');
                break;
            case (classList.contains('afterhours-edit-listb')):
                console.log('list b edit');
                break;
        };
    },
    ...
    saveDestinationToStore: function (targetStore, newPhone, newTimeout, vm, storeName) {
    ...
    addNewDestination: function (element) {
        ...
        switch (targetId) {
            ...
            case 'companyhours-onlineSaveButton':
                me.validateDestinationForm('CallForwardOnline');
                break;
            ...
            case 'companyhours-busySaveButton':
                me.validateDestinationForm('CallForwardBusy');
                break;
            ...
            case 'companyhours-offlineSaveButton':
                me.validateDestinationForm('CallForwardOffline');
                break;
        };
    },
