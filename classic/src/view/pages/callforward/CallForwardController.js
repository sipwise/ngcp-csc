Ext.define('NgcpCsc.view.pages.callforward.CallForwardController', {
    ...
    renderDestinationColumn: function(value, metaData, record) {
        ...
        if (record.get('destination') === 'own phone') {
            // TODO Timeout not rendering after adding and deleting in empty online. Fixed?
            return Ext.String.format('Own phone and ring for {0} secs', record.get('timeout') || 15);
    ...
    writeNewDestinationToStore: function(store, destination, timeout) {
        ...
        // TODO Deleting all online numbers except own phone, and thne adding a new one, results in "own phone" being displayed twice. Fix
