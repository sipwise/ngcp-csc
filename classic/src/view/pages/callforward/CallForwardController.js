Ext.define('NgcpCsc.view.pages.callforward.CallForwardController', {
    ...
    removeEntry: function(grid, rowIndex, colIndex) {
        ...
        this.fireEvent('showconfirmbox', Ngcp.csc.locales.common.remove_confirm[localStorage.getItem('languageSelected')], Ngcp.csc.locales.common.remove_success[localStorage.getItem('languageSelected')], 'confirmCFRemoval', rec);
    },
