Ext.define('NgcpCsc.view.pages.callforward.CallForwardController', {
    ...
    changeWidget: function (target, vm) {
        ...
        vm.set('list_a', true);
        vm.set('list_b', true);
        if (target == 'afterHoursButton-btnIconEl') {
        ...
        } else if (target == 'companyHoursButton-btnIconEl') {
    ...
    loadRecordsIntoStore: function (storeName, record) {
        // TODO: Use loadData and commitChanges instead of add
    ...
    clickSegmentedButton: function (button, event) {
        ...
        // this is preferred style, as this has the risk of forgetting to the
        // semicolon with colon for the second to last variable.
        var me = this,
            vm = me.getViewModel(),
        ...
        (buttonType == 'timeButtons') && (function () {vm.set('selected_timeset', buttonValue)})();
        (buttonType == 'sourceButtons') && (function () {vm.set('selected_sourceset', buttonValue)})();
        Ext.Ajax.request({
                    ...
                    for (node in combinationStore) {
                        ...
                        if (me.checkIndexOf(storeName, node) && me.checkIndexOf(selectedTimeset, node) && me.checkIndexOf(selectedSourceset, node)) {
                            ...
                            for (record in gridStore) {
                                // 1c. loadData inside the store
                                // 1d. commitChanges of the store
