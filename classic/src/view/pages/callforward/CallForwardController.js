...
Ext.define('NgcpCsc.view.pages.callforward.CallForwardController', {
    ...
    cfStoreLoaded: function(store, data) {
        ...
        Ext.each(cfTypeObjects, function(cfTypeObject) {
            for (index in cfTypeObject) {
                console.log(cfTypeObject[index]);
                // Returns quickset_cfu, null, null (for [0], [1] and [2] respectively)
                // TODO: Ajax request to /api/destinationsets/ to grab destinations:
                // http://docs.sencha.com/extjs/6.2.0/classic/Ext.Ajax.html
            }
        });
