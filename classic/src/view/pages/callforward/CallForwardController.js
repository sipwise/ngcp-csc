Ext.define('NgcpCsc.view.pages.callforward.CallForwardController', {
    ...
    isLastOnlineDestinationOfId: function(record, store) {
        ...
        console.log('store at 0', store.getAt(0));
        return (store.getCount() === 2 && store.getAt(0).get('destination') === "own phone")
    },
    ...
    confirmCFRemoval: function(record) {
        ...
        console.log('isLastOnlineDestinationOfId', isLastOnlineDestinationOfId);
        if ($cf.recordHasStoreAndOwnPhone(record)) {
            ...
            Ext.Ajax.request({
                ...
                success: function(response) {
                    ...
                    if (isLastOnlineDestinationOfId) {
                        console.log('isLastOnlineDestinationOfId');
                        Ext.Ajax.request({
            ...
            // TODO Ajax request with PATCH and op remove path cfu/cft/cfna/cfb  
            Ext.Ajax.request({
                url: '/api/cfmappings/' + subscriberId,
                method: 'PATCH',
                headers: {
    ...
    isLastDestinationInStore: function(store) {
