    ...
    initComponent: function() {
        ...
        var busyGrid = Ext.create('NgcpCsc.view.pages.callforward.CallForwardMainGrid', {
            store: Ext.create('NgcpCsc.store.CallForward', {
                storeId: this._prefix + 'afterhours-CallForwardBusy',
                proxy: {
                    type: 'ajax',
        ...
        var onlineGrid = Ext.create('NgcpCsc.view.pages.callforward.CallForwardMainGrid', {
            store: Ext.create('NgcpCsc.store.CallForward', {
                storeId: this._prefix + 'afterhours-CallForwardOnline',
                proxy: {
                    type: 'ajax',
        ...
        var offlineGrid = Ext.create('NgcpCsc.view.pages.callforward.CallForwardMainGrid', {
            store: Ext.create('NgcpCsc.store.CallForward', {
                storeId: this._prefix + 'afterhours-CallForwardOffline',
                proxy: {
                    type: 'ajax',
        ...
        this.items = [{
            ...
            items: [{
                ...
                id: this._prefix + 'afterhours-lista_titleField-saveButton',
                margin: '0 0 0 10',
                ...
                callForwardListAGrid,
            {
                ...
                items: [{
                    ...
                    id: this._prefix + 'afterhours-lista_titleField-showButton',
                    margin: '0 0 0 10',
            ...
            items: [{
                ...
                xtype: 'button',
                html: 'SAVE', // TODO: Locales
                id: this._prefix + 'afterhours-listb_titleField-saveButton',
                margin: '0 0 0 10',
                handler: 'saveNewTitle'
            }]
        },
                callForwardListBGrid,
            {
                ...
                items: [{
                    ...
                    xtype: 'button',
                    html: 'CHANGE TITLE', // TODO: Locales
                    id: this._prefix + 'afterhours-listb_titleField-showButton',
                    margin: '0 0 0 10',
                    handler: 'toggleChangeTitle'
                }]
        }, {
