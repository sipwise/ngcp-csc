    ...
    initComponent: function() {
        this.plugins = [{
            ...
            rowBodyTpl: new Ext.XTemplate(
                ...
                '<div class="card-data-row"><span class="fa fa-file-text-o"></span>' + Ngcp.csc.locales.common.duration[localStorage.getItem('languageSelected')] + '</b>: {duration}</div>',
                '<div class="card-data-row"><span class="fa fa-file-text-o"></span>' + Ngcp.csc.locales.calls.charges[localStorage.getItem('languageSelected')] + '</b>: {charges} </div>',
                '<div class="card-data-row"><span class="fa fa-file-text-o"></span>' + Ngcp.csc.locales.common.date[localStorage.getItem('languageSelected')] + '</b>: {[ Ext.util.Format.date(values.start_time, "d.m.Y h:i:s")]} </div>',
                ...
                '<div class="card-wrapper">',
                '<div class="card-data-row"><span class="fa fa-file-text-o"></span>' + Ngcp.csc.locales.common.caller[localStorage.getItem('languageSelected')] + '</b>: {number}</div>',
                '<div class="card-data-row"><span class="fa fa-file-text-o"></span>' + Ngcp.csc.locales.common.duration[localStorage.getItem('languageSelected')] + '</b>: {duration} </div>',
                '<div class="card-data-row"><span class="fa fa-file-text-o"></span>' + Ngcp.csc.locales.common.date[localStorage.getItem('languageSelected')] + '</b>: {[ Ext.util.Format.date(values.start_time, "d.m.Y h:i:s")]} </div>',
                '<div class="card-icon-row">',
