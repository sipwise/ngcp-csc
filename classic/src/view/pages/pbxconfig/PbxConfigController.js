// TODO: 1. Groups should also have Primary/Alias and Seats
// DONE: a. Implement in view, model and .json
// TODO: b. Implement in gridfilters
// DONE: 2. Button text wrong some times - Not able to reproduce
Ext.define('NgcpCsc.view.pages.pbxconfig.PbxConfigController', {
    ...
    showHideFocusFieldsById: function(id, storeName, hideOrShow) {
        ...
        var seatsLabel = Ext.ComponentQuery.query('#' + viewName + '-tagfield-seats-' + id) || '';
