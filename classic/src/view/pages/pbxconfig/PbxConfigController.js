Ext.define('NgcpCsc.view.pages.pbxconfig.PbxConfigController', {
    ...
    saveSeat: function(el) {
        ...
        var savedCount = 0;
        var nameField = me.getFieldComponent('mainname', recId)[0];
        var nameLabel = me.getLabelComponent('mainname', recId)[0];
        ...
        // TODO: Not working, see console error
        if (nameField.value.length > 0 &&
            fieldLabelPairs[0][0].value.length > 0 &&
            fieldLabelPairs[1][0].value.length > 0 &&
            fieldLabelPairs[2][0].value.length > 0 &&
            fieldLabelPairs[3][0].value.length > 0) {
    ...
    showAllFieldsById: function(id) {
        var mainNameLabel = Ext.ComponentQuery.query('#textfield-mainname-' + id);
        ...
        nameField[0].focus();
        // var el = document.getElementById('editSeat-' + id);
        // var elClassList = el.firstChild.classList;
        // elClassList.remove('fa-edit')
        // elClassList.add('fa-floppy-o');
        // el.dataset.callback = 'saveSeat';
