Ext.define('NgcpCsc.view.pages.pbxconfig.PbxConfigController', {
    ...
    listen: {
        controller: {
            '*': {
                ...
                cardRemoveConfirmed: 'cardRemoveConfirmed'
            }
        }
    },
    ...
    removeCard: function(el) {
        ...
        me.fireEvent('showconfirmbox', Ngcp.csc.locales.common.remove_confirm[localStorage.getItem('languageSelected')], Ngcp.csc.locales.common.remove_success[localStorage.getItem('languageSelected')], 'cardRemoveConfirmed', selectedRow)

    },

    cardRemoveConfirmed:function(card){
