Ext.define('NgcpCsc.view.pages.pbxconfig.PbxConfigController', {
    ...
    // TODO: Create new refactoring task, to simplify this funciton. Implement
    // according to cvenusino's review comments. From cvenusino:
    // A bit of overengineering here. What  this function should do is
    // 1. select all the textfields which belongs to the card parent of the save
    // button (card panel will need an id like seats-[seatId] which is taken
    // from the button el)
