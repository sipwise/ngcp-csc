        ...
        widget: {
            ...
            items: [{
                ...
                items: [{
                    ...
                    listeners: {
                        // looks like the problem occurs when the record
                        // gets updated; for some reason (which can be how we are using
                        // defaultBindProperty and bind for form) a change in any record field
                        // triggers a layout break in the row which looks like row
                        // collapse, but in fact is not (you can place the collapsebody listener
                        // in viewConfig and check). The workaround is to remove the bind from the field,
                        // place the label value in the field when focused
                        // and update the label in saveRecord callback on field blur.
                        // It might be good to share the issue in sencha forum to get some feeds.
                        focus:function(cmp){
