Ext.define('NgcpCsc.view.pages.callblocking.incoming.Incoming', {
    ...
    // DONE: 1. Switch to rowbody
    // DONE: 2. Implement listener that toggles enabled/disabled
    // TODO: 2b. Implement listener that toggles delete number
    ...
    // DONE: 6. Fix styling to be in line with conversations (mainly border,
