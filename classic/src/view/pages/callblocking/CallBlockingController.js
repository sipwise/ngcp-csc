Ext.define('NgcpCsc.view.pages.callblocking.CallBlockingController', {
    ...
    listen: {
        controller: {
            '*': {
                confirmCallBlockingRemove: 'confirmCallBlockingRemove'
            }
        }
    },
    ...
    deleteRecord: function(event) {
        ...
        var store = Ext.getStore(storeName);
        this.fireEvent('showconfirmbox', Ngcp.csc.locales.common.remove_confirm[localStorage.getItem('languageSelected')], Ngcp.csc.locales.common.remove_success[localStorage.getItem('languageSelected')], 'confirmCallBlockingRemove', rec);
    },

    confirmCallBlockingRemove: function(record) {
