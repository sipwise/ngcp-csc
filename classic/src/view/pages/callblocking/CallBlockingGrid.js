    ...
    initComponent: function() {
        ...
        me.features = [{
            ...
            getAdditionalData: function(data, idx, record) {
                ...
                var deleteIcon = '<div id="deleteRecord-' + record.get('id') + '" class="card-icon" data-callback="deleteRecord"><i class="'+Ngcp.csc.icons.trash+' fa-2x" aria-hidden="true" data-qtip="' + Ngcp.csc.locales.callblocking.delete_number[localStorage.getItem('languageSelected')] + '"></i></div>';
                return {
