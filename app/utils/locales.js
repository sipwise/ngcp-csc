Ext.define('Ngcp.csc.locales', {
    statics: {
        ...
        callforward: {
            ...
            invalid_times: {
                en: '<div class="cf-invalid-period-box">There are invalid time periods in the timeset; allowed fields are Weekday and Hour. Please fix your time periods or reset the timeset by clicking on the Create button.</div>'
            },
            tooltips: {
                change_time_from: {
                    en: 'Change time from',
