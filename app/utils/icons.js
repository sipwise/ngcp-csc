/*
Utility for collecting all the Font Awesome icons
...
Ext.define('Ngcp.csc.icons', {
    statics: {
        ...
        chat: "fa-comment",
        desktop: "fa-desktop",
        doublearrowright: "fa-angle-double-right",
        edit: "fa-edit",
        fax: "fa-fax",
        faxpaper: "fa-file-text",
        filter: "fa-filter",
        folder: "fa-folder-open-o",
        incoming: "fa-chevron-left",
        home: "fa-home",
        key: "fa-key",
        lock: "fa-lock",
